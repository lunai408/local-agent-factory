...
```bash
docker build -t local-agent-memory-ui .
```
...
|----------|---------|-------------|
| `NEXT_PUBLIC_API_URL` | `http://localhost:7777` | Backend API URL |
| `NEXT_PUBLIC_OS_SECURITY_KEY` | - | Auth token (optional) |
